...
:- type instr
	...
	;	c_code(string, list(rval))
			% Do whatever is specified by the string,
			% which can be any piece of C code that
			% does not have any non-local flow of control.
			% The list of rvals are inserted in the C code.
			% The first element of the list replaces all
			% occurences of the literal `$1', the second all
			% occurences of the literal `$2', and so on.
