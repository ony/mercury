%-----------------------------------------------------------------------------%
% Copyright (C) 1993-2002,2004 The University of Melbourne.
...
pred_add_pragma_import(PredInfo0, PredId, ProcId, Attributes, C_Function,
	...
	clauses_info_add_pragma_foreign_proc(Clauses0, Purity, Attributes,
		...
		varset__init, PragmaImpl, Context, PredOrFunc,
...
clauses_info_add_pragma_foreign_proc(ClausesInfo0, Purity, Attributes0, PredId,
		ProcId, PVarSet, PVars, OrigArgTypes, TVarSet, 
		PragmaImpl0, Context,
	...
	foreign__extrude_pragma_implementation(BackendForeignLanguages,
		...
		ModuleInfo1, Attributes1, PragmaImpl),
	...
	;
		...
		->
			...
			% variables). 
			aliasing(Attributes1, Aliasing0), 
			rename_aliasing(Aliasing0, Args0, HeadVars,
				OrigArgTypes, TVarSet, Aliasing), 
			set_aliasing(Attributes1, Aliasing, Attributes)
		;
