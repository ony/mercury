...
std_util__get_functor(TypeDesc, I, Functor, Arity, TypeInfoList, ArgNameList) :-
    std_util__get_functor_2(TypeDesc, I, Functor, Arity, TypeInfoList, ArgNameList0),
    ArgNameList = list__map(null_to_no, ArgNameList0).
