...
/*
** Framevar(1) and possibly framevar(2) are used to save the inputs
** of the unification code. The first framevar available
** for saving deep profiling information is framevar(3).
*/
